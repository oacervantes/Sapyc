Public Class frmClientesConflick
    ...
    Private Sub formatoGrid()
        ...
        gridClaves.Columns("CTEFISCAL").AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill
        ...
        gridClaves.Columns("INDEPENDENCIA").Width = 110

        gridClaves.Columns("BACKGROUNDCHECK").HeaderText = "BACKGROUND CHECK"
        gridClaves.Columns("BACKGROUNDCHECK").Width = 110
    End Sub
