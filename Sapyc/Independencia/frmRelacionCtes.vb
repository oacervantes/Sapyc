Public Class frmRelacionCtes

    Private bsCtes As New BindingSource
    Private dtCtes As New DataTable

    Private Sub frmRelacionCtes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnExportar_Click(sender As Object, e As EventArgs) Handles btnExportar.Click
        ...
        Try
            If MsgBox("¿Desea exportar la información a Excel?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Envío Excel") = MsgBoxResult.Yes Then
                ...
                dlg.txtArchivo.Text = "Lista de Clientes"
                If dlg.ShowDialog = Windows.Forms.DialogResult.OK Then

                    exportarCtes(objExcel, dgCtes, dlg.txtDirectorio.Text, dlg.txtArchivo.Text)
