...
Public Class ClientesRestringidosSSGT
    ...
    Private Sub ClientesRestringidosSSGT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
                ...
                If sHoja = "Listas Negras" Then
                    ...
                    With elWB
                        While CStr(.Worksheets(sHoja).Cells(iFila, 1).Value) <> String.Empty
                            ...
                            sNombre = .Worksheets(sHoja).Cells(iFila, 3).Value.ToString().Trim()
