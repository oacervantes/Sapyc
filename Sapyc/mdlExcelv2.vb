...
#Region "SAPYC"
    ...
    Public Sub exportarTrabajosv2(ByVal grid As DataGridView, ByVal sRutaArchivo As String, ByVal sNombreArchivo As String)
        Dim exc As New SLDocument
    ...
    Public Sub exportarCtesv2(ByVal grid As DataGridView, ByVal sRutaArchivo As String, ByVal sNombreArchivo As String)
        Dim exc As New SLDocument
    ...
    Public Sub exportarFoliosv2(ByVal grid As DataGridView, ByVal sRutaArchivo As String, ByVal sNombreArchivo As String)
        Dim exc As New SLDocument
