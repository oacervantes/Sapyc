Public Class DlgServiciosCte
    ...
    Public dtServiciosCte As New DataTable
        ...
        Try
            ...
            If dtServ.Rows.Count > 0 Then
                For Each row As DataRow In dtServ.Rows
                    ...
                    drServicios("CVE") = row("CVE").ToString().Trim()
