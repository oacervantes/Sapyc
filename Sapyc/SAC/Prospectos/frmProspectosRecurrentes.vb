Public Class FrmProspectosRecurrentes
    ...
    Private sNameRpt As String = "Alta Clientes Prospectos Recurrentes"
    ...
    Private Sub BtnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevo.Click
        ...
        Dim frm As New FrmContactoRecurrente With {
            .iOrigen = 1,
            .idSAC = idSAC
        }
    ...
    Private Sub BtnEditar_Click(sender As Object, e As EventArgs) Handles btnEditar.Click
        Dim frm As New FrmContactoRecurrente
        ...
        If gridProspectos.CurrentRow IsNot Nothing Then
            If gridProspectos.CurrentRow.Cells("cStatus").Value = "P" Or gridProspectos.CurrentRow.Cells("cStatus").Value = "V" Then
                Dim sCveCte As String = gridProspectos.CurrentRow.Cells("sCveCte").Value
                Dim sNombreCte As String = gridProspectos.CurrentRow.Cells("sNombreCte").Value

                frm.iModifica = 1
                frm.iOrigen = 2
                frm.idSAC = gridProspectos.CurrentRow.Cells("idSAC").Value
                frm.sCveCte = If(sCveCte Is DBNull.Value, "", sCveCte)
                frm.sNombreCte = If(sNombreCte Is DBNull.Value, "", sNombreCte)
    ...
    Private Sub ListarSolicitudesSAC()
        Try
            ...
            If dtSolicitudes.Rows.Count > 0 Then
                ...
                gridProspectos.Columns("sCveCte").Visible = False
    ...
    Private Sub InsertarSolicitudSAC()
        Try
            ...
            End With
        Catch ex As Exception
            InsertarErrorLog(100, sNameRpt, ex.Message, sCveUsuario, "InsertarSolicitudSAC()")
