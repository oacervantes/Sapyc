...
Public Class ComoSeEntero

    Public sCve As String
    Public sDes As String
    Public iTipo As Integer

    Private Sub ComoSeEntero_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        MostrarDatos()
    End Sub
    ...
    Public Sub MostrarDatos()
        ...
        sSQL = "SELECT CVE, DESCRIPCION FROM COMOSEENTERO ORDER BY CVE ASC "
    ...
    Private Sub Bmodificar_Click(sender As Object, e As EventArgs) Handles Bmodificar.Click
        If Lista.SelectedRows.Count > 0 Then
            ...
            MttoCEntero.sCve = sCve
            MttoCEntero.sDes = sDes
            MttoCEntero.iTipo = 2
            MttoCEntero.ShowDialog()
            Me.Focus()
            ...
            MttoCEntero.Dispose()
        Else
            MsgBox("Debe seleccionar un registro de la lista", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, "COMO SE ENTERO")
        End If
    End Sub
    ...
    Private Sub Bbaja_Click(sender As Object, e As EventArgs) Handles Bbaja.Click
        ...
        If Lista.SelectedRows.Count > 0 Then
            ...
            If MsgBox("¿Estas seguro de eliminar esté giro", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Eliminar") = MsgBoxResult.Yes Then
                ...
                MsgBox("COMO SE ENTERO ELIMINADO CORRECTAMENTE", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, "COMOSEENTERO")
                MostrarDatos()
