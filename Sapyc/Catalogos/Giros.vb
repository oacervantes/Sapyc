...
Public Class Giros
    ...
    Public Sub MostrarDatos()
        ...
        sSQL = "SELECT CVE, DESCRIPCION FROM GIROS ORDER BY CVE ASC "
    ...
    Private Sub Giros_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        MostrarDatos()
    End Sub
    ...
    Private Sub Bmodificar_Click(sender As Object, e As EventArgs) Handles Bmodificar.Click
        ...
        If Lista.SelectedRows.Count > 0 Then
            ...
            MttoGiros.Dispose()
        Else
            MsgBox("Debe seleccionar un registro de la lista", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, "GIROS")
        End If
    ...
    Private Sub Bbaja_Click(sender As Object, e As EventArgs) Handles Bbaja.Click
        ...
        If Lista.SelectedRows.Count > 0 Then
            ...
            If MsgBox("¿Estas seguro de eliminar esté giro", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Eliminar") = MsgBoxResult.Yes Then
                ...
                MsgBox("Giro eliminado correctamente", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, "Giros")
                MostrarDatos()
