...
Public Class MedioContacto
    ...
    Private Sub MedioContacto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        MostrarDatos()
    End Sub
    Private Sub Balta_Click(sender As Object, e As EventArgs) Handles Balta.Click
        MttoContacto.iTipo = 1
        MttoContacto.ShowDialog()
        Me.Focus()

        MostrarDatos()
        MttoContacto.Dispose()
    End Sub
    Private Sub Bmodificar_Click(sender As Object, e As EventArgs) Handles Bmodificar.Click
        If Lista.SelectedRows.Count > 0 Then
            ...
            MttoContacto.sCve = sCve
            MttoContacto.sDes = sDes
            MttoContacto.iTipo = 2
            MttoContacto.ShowDialog()
            Me.Focus()
            ...
            MttoContacto.Dispose()
        Else
            MsgBox("Debe seleccionar un registro de la lista", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, "MEDIO CONTACTO")
        End If
    End Sub
    Private Sub Bbaja_Click(sender As Object, e As EventArgs) Handles Bbaja.Click
        ...
        If Lista.SelectedRows.Count > 0 Then
            ...
            If MsgBox("¿Estas seguro de eliminar esté giro", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Eliminar") = MsgBoxResult.Yes Then
                ...
                MsgBox("MEDIO DE CONTACTO ELIMINADO CORRECTAMENTE", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, "MEDIODECONTACTO")
                MostrarDatos()
    ...
    Public Sub MostrarDatos()
        ...
        sSQL = "SELECT CVE, DESCRIPCION FROM MEDIODECONTACTO ORDER BY CVE ASC "
