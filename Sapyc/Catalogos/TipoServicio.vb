...
Public Class TipoServicio
    ...
    Private Sub TipoServicio_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        MostrarDatos()
    End Sub
    Private Sub Balta_Click(sender As Object, e As EventArgs) Handles Balta.Click
        MttoTpServicio.iTipo = 1
        MttoTpServicio.ShowDialog()
        Me.Focus()

        MostrarDatos()
        MttoTpServicio.Dispose()
    End Sub
    Private Sub Bmodificar_Click(sender As Object, e As EventArgs) Handles Bmodificar.Click
        If Lista.SelectedRows.Count > 0 Then
            ...
            MttoTpServicio.sCve = sCve
            MttoTpServicio.sDes = sDes
            MttoTpServicio.iTipo = 2
            MttoTpServicio.ShowDialog()
            Me.Focus()
            ...
            MttoTpServicio.Dispose()
        Else
            MsgBox("Debe seleccionar un registro de la lista", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, "TIPO DE SERVICIO")
        End If
    End Sub
    Private Sub Bbaja_Click(sender As Object, e As EventArgs) Handles Bbaja.Click
        If Lista.SelectedRows.Count > 0 Then
            ...
            If MsgBox("¿Estas seguro de eliminar esté giro", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Eliminar") = MsgBoxResult.Yes Then
                ...
                MsgBox("TIPO DE SERVICIO ELIMINADO CORRECTAMENTE", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, "TIPODESERVICIO")
                MostrarDatos()
    ...
    Public Sub MostrarDatos()
        ...
        sSQL = "SELECT CVE, DESCRIPCION FROM TIPODESERVICIO ORDER BY CVE ASC "
