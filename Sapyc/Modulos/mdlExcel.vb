...
Module mdlExcel
    ...
    Public Sub exportarCtes(ByVal objExcel As Excel.Application, ByVal grid As DataGridView, ByVal sRutaArchivo As String, ByVal sNombreArchivo As String)
        Try
            ...
            objCelda = objHojaExcel.Range("A1:AD2")
            objCelda.Rows.RowHeight = 30

            objCelda = objHojaExcel.Range("A4:AD4")
            objCelda.Interior.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.FromArgb(79, 45, 127))
            objCelda.Font.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.FromArgb(255, 255, 255))
            objCelda.WrapText = True
            objCelda.Rows.RowHeight = 30
            ...
            For x As Integer = 0 To grid.Rows.Count - 1
                If x Mod 2 = 0 Then
                    objCelda = objHojaExcel.Range("A" & x + 5 & ":AD" & x + 5)
                    objCelda.Interior.Color = System.Drawing.ColorTranslator.ToOle(Color.Transparent)
                Else
                    objCelda = objHojaExcel.Range("A" & x + 5 & ":AD" & x + 5)
                    objCelda.Interior.Color = System.Drawing.ColorTranslator.ToOle(Color.FromArgb(227, 231, 237))
            ...
            objHojaExcel.Range("A4", "AD4").AutoFilter(1, Type.Missing, Excel.XlAutoFilterOperator.xlAnd, Type.Missing, True)
    ...
    Public Sub exportarCtesPeriodo(ByVal objExcel As Excel.Application, ByVal grid As DataGridView, ByVal sRutaArchivo As String, ByVal sNombreArchivo As String)
        ...
        End Try
    End Sub
    Public Sub exportarRechazados(ByVal objExcel As Excel.Application, ByVal grid As DataGridView, ByVal sRutaArchivo As String, ByVal sNombreArchivo As String)
        Try
            If objExcel Is Nothing Then
                objExcel = New Excel.Application
                objLibroExcel = objExcel.Workbooks.Add()
            ...
            objCelda = objHojaExcel.Range("A1:G2")
            objCelda.Rows.RowHeight = 30

            objCelda = objHojaExcel.Range("A4:G4")
            objCelda.Interior.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.FromArgb(79, 45, 127))
            objCelda.Font.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.FromArgb(255, 255, 255))
            objCelda.WrapText = True
            objCelda.Rows.RowHeight = 30
            ...
            For x As Integer = 0 To grid.Rows.Count - 1
                If x Mod 2 = 0 Then
                    objCelda = objHojaExcel.Range("A" & x + 5 & ":G" & x + 5)
                    objCelda.Interior.Color = System.Drawing.ColorTranslator.ToOle(Color.Transparent)
                Else
                    objCelda = objHojaExcel.Range("A" & x + 5 & ":G" & x + 5)
                    objCelda.Interior.Color = System.Drawing.ColorTranslator.ToOle(Color.FromArgb(227, 231, 237))
            ...
            nombreReporte(objCelda, "PROPUESTAS RECHAZADAS", "A3", grid.Columns.Count)
            objCelda = objHojaExcel.Range("A5")
            objCelda.Columns.ColumnWidth = 90
            objCelda = objHojaExcel.Range("B5")
            objCelda.Columns.ColumnWidth = 35
            ...
            objHojaExcel.Range("A4", "G4").AutoFilter(1, Type.Missing, Excel.XlAutoFilterOperator.xlAnd, Type.Missing, True)
        ...
        End Try
    End Sub
    Public Sub exportarProspectosSac(ByVal objExcel As Excel.Application, ByVal grid As DataGridView, ByVal sRutaArchivo As String, ByVal sNombreArchivo As String)
        Try
            If objExcel Is Nothing Then
                objExcel = New Excel.Application
                objLibroExcel = objExcel.Workbooks.Add()
            ...
            objCelda = objHojaExcel.Range("A1:H2")
            objCelda.Rows.RowHeight = 30

            objCelda = objHojaExcel.Range("A4:H4")
            objCelda.Interior.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.FromArgb(79, 45, 127))
            objCelda.Font.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.FromArgb(255, 255, 255))
            objCelda.WrapText = True
            objCelda.Rows.RowHeight = 30
            ...
            For x As Integer = 0 To grid.Rows.Count - 1
                If x Mod 2 = 0 Then
                    objCelda = objHojaExcel.Range("A" & x + 23 & ":H" & x + 23)
                    objCelda.Interior.Color = System.Drawing.ColorTranslator.ToOle(Color.Transparent)
                Else
                    objCelda = objHojaExcel.Range("A" & x + 23 & ":H" & x + 23)
                    objCelda.Interior.Color = System.Drawing.ColorTranslator.ToOle(Color.FromArgb(227, 231, 237))
            ...
            nombreReporte(objCelda, "PROSPECTOS SAC", "A3", grid.Columns.Count)
            objCelda = objHojaExcel.Range("A5")
            objCelda.Columns.ColumnWidth = 2
            objCelda = objHojaExcel.Range("B5")
            objCelda.Columns.ColumnWidth = 100
            objCelda = objHojaExcel.Range("C5")
            objCelda.Columns.ColumnWidth = 25
            ...
            objHojaExcel.Range("A4", "H4").AutoFilter(1, Type.Missing, Excel.XlAutoFilterOperator.xlAnd, Type.Missing, True)
